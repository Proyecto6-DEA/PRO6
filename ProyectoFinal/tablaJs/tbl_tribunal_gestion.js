...
$('#tblTribunalGestion').bootstrapTable({
                        method: 'get',
                        url: 'select_proyecto_tribunal.proc.php',
                        cache: false,
                        striped: true,
                        pagination: false,
                        search: true,
        ...
        $.ajax({
                    ...
                    success: function(data){
                            ...
                            for ( i in data) {
                                ...
                                if(pregTipo!='Contingut'){
                                    if(numero<2){
                                        var cajas='<div class="col-md-5"><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl1+'" placeholder="nota" required></div></div>';
                                    }else if(numero<3){
                                        var cajas='<div class="col-md-5"><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl1+'" placeholder="nota" required></div><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl2+'" placeholder="nota" required></div></div>';
                                    }else{
                                        var cajas='<div class="col-md-5"><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl1+'" placeholder="nota" required></div><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl2+'" placeholder="nota" required></div><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl3+'" placeholder="nota" required></div></div>';
                                    }
                                    ...
                                    if(numero<2){
                                        var cajas='<div class="col-md-5"><div class="col-md-4"><input type="number" class="form-control" name="'+id+'_'+idAl1+'_'+idAl2+'_'+idAl3+'" placeholder="nota" required></div></div>';
                                    }else if(numero<3){
                                        var cajas='<div class="col-md-5"><div class="col-md-8"><input type="number" class="form-control" name="'+id+'_'+idAl1+'_'+idAl2+'_'+idAl3+'" placeholder="nota" required></div></div>';
                                    }else{
                                        var cajas='<div class="col-md-5"><div class="col-md-12"><input type="number" class="form-control" name="'+id+'_'+idAl1+'_'+idAl2+'_'+idAl3+'" placeholder="nota" required></div></div>';
                                    }

                                        // var cajas='<div class="col-md-4"><div class="col-md-12"><input type="number" class="form-control" name="'+id+'_'+idAl1+'_'+idAl2+'_'+idAl3+'" placeholder="nota"></div></div>';
