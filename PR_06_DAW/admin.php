...
<html>
    ...
    <!-- TABLAS JS -->
        ...
        <script type="text/javascript" src="tablaJs/tbl_proyecto.js"></script>
            ...
            <div class="modal-dialog modal-lg" >
                <div class="modal-content" >
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="UsuGrupTitulo">Crea Usuari: </h4>
                    </div>
                      ...
                      <form class="form-horizontal" id="formusuario" onsubmit="return addusuario()" method="POST">
                        <div class="row">
                            <div class="form-group col-lg-6">
                              ...
                              <input type="text" id="per_cp1" class="form-control col-lg-5" name="nombre"
                                     placeholder="Nom">
                            </div>
                            <div class="form-group col-lg-6">
                              <label for="ejemplo_email_1">Cognom:</label>
                              <input type="text" id="per_cp1" class="form-control col-lg-5" name="apellido"
